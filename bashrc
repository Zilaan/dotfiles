...
# export PS1="\[\e[33m\]\u\[\e[m\]:\[\e[34m\]\W\[\e[m\]@\[\e[31m\]\`parse_git_branch\`\[\e[m\] \[\e[32m\]\\$\[\e[m\] "

# export PS1="\`if [[ \$? = "0" ]]; then echo "\\[\\033[32m\\]"; else echo "\\[\\033[31m\\]"; fi\`[\u@\`if [[ `pwd|wc -c|tr -d " "` > 18 ]]; then echo "\\W"; else echo "\\w"; fi\`]\$\[\033[0m\] "; echo -ne "\033]0;`hostname -s`:`pwd`\007 \[\033[31m\] `parse_git_branch` \[\033[0m\]"
...
# PS1='\[\033]0;$MSYSTEM:\w\007 \033[32m\]\u@\W\[\033[33m$(fast_git_ps1)\033[0m\]$ '
PS1='\u\[\033[31m\]@\[\033[0m\]\[\033[34m\]\W\[\033[0m\]\[\033[33m$(fast_git_ps1)\033[0m\]$ '
